...
namespace Zhoubin.Infrastructure.Common.Extent
{
    ...
    public static class DynamicQueryable
    {
        ...
        /// </summary>
        /// <param name="source">IQueryable对象</param>
        /// <param name="selector">选择项字符串</param>
        /// <param name="values">动态变量</param>
        /// <returns>IQueryable对象</returns>
        ...
        /// <param name="source">待排序IQueryable对象</param>
        /// <param name="ordering">排序字符串</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回排序后IQueryable对象</returns>
        ...
        /// 获取指定数量记录
        /// </summary>
        /// <param name="source">待处理IQueryable对象</param>
        ...
        /// 对象分组
        /// </summary>
        /// <param name="source">待分组IQueryable对象</param>
        /// <param name="keySelector">关键字</param>
        /// <param name="elementSelector">选择项</param>
        /// <param name="values">动态参数</param>
        /// <returns>返回分组后IQueryable对象</returns>
        ...
        /// 检查是否存在对象
        /// </summary>
        /// <param name="source">待检查IQueryable对象</param>
        /// <returns>对象存在返回true,其他返回false</returns>
        ...
        /// 统计对象数量
        /// </summary>
        /// <param name="source">待统计IQueryable对象</param>
        /// <returns>返回统计后结果</returns>
        ...
        /// 对象除重
        /// </summary>
        /// <param name="source">待除重IQueryable对象</param>
        /// <returns>返回除重后IQueryable对象</returns>
        ...
        /// <param name="source">IEnumerable对象</param>
        /// <param name="predicate">条件</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回增加过虑条件后的IEnumerable对象</returns>
        ...
        /// </summary>
        /// <param name="source">IEnumerable对象</param>
        /// <param name="predicate">字符串条件</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回增加条件后IEnumerable对象</returns>
        ...
        /// </summary>
        /// <param name="source">IEnumerable对象</param>
        /// <param name="selector">字段列表</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回选择字段后IEnumerable对象</returns>
        ...
        /// <typeparam name="T">对象类型</typeparam>
        /// <param name="source">IEnumerable对象</param>
        /// <param name="ordering">排序表达式</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回排序后IEnumerable对象</returns>
        ...
        /// </summary>
        /// <param name="source">IEnumerable对象</param>
        /// <param name="ordering">反序表达式</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回排序后IEnumerable对象</returns>
        ...
        /// <returns>返回IEnumerable对象</returns>
        ...
        /// </summary>
        /// <param name="source">IEnumerable对象</param>
        /// <param name="keySelector">分组字符串</param>
        /// <param name="elementSelector">选择对象字符串</param>
        /// <param name="values">动态变量</param>
        /// <returns>返回分组为对象</returns>
        ...
        /// </summary>
        /// <param name="source">IEnumerable对象</param>
        /// <returns>存在返回true，其他返回false</returns>
        ...
        /// </summary>
        /// <param name="source">IEnumerable对象</param>
        /// <returns>返回去重后IEnumerable对象</returns>
    ...
    public abstract class DynamicClass
    {
        ...
        /// 当前类型ToStribg()方法
        /// </summary>
        /// <returns>输出当前的类型的所有公有和实例唾弃属性</returns>
    ...
    public static class DynamicExpression
    {
        ...
        /// 表达式解析
        /// </summary>
        /// <param name="parameters">表达式参数定义</param>
        /// <param name="resultType">结果类型</param>
        /// <param name="expression">表达式</param>
        /// <param name="values">参数值</param>
        /// <returns>返回解析好的表达式对象</returns>
        ...
        /// 根据动态属性列表，获取类型
        /// </summary>
        /// <param name="properties">动态属性数组</param>
        /// <returns>返回属性类型：Type</returns>
        ...
        /// 根据动态属性列表，获取类型
        /// </summary>
        /// <param name="properties">动态属性列表</param>
        /// <returns>返回属性类型：Type</returns>
