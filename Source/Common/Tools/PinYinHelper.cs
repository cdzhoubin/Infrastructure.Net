...
namespace Zhoubin.Infrastructure.Common.Tools
{
    public partial class PinYinHelper
    {
        ...
        public static string GetInitials(string text, Encoding encoding)
        {
            ...
            return Pinyin(text, encoding, GetInitials);
        }
        ...
        public static string GetPinyin(string text, Encoding encoding)
        {
            ...
            return Pinyin(text, encoding, GetPinyin);
        }
        ...
        public static string GetChineseText(string pinyin, Encoding encoding)
        {
            ...
            return Pinyin(pinyin, encoding, GetChineseText);
        }

        private static string Pinyin(string text,Encoding encoding,Func<string,string> func)
        {
            if (encoding == Encoding.UTF8)
            {
                return func(text);
            }
            string text1 = ConvertEncoding(text, encoding, Encoding.UTF8);
            return ConvertEncoding(func(text1), Encoding.UTF8, encoding);
        }
